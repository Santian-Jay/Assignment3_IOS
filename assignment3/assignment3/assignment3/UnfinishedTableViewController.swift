//
//  UnfinishedTableViewController.swift
//  assignment3
//
...
class UnfinishedTableViewController: UITableViewController {
    var uhistories = [History]()
...
//                            {
                                ...
                                if(convertedDoc.completed == false){
                                    self.uhistories.append(convertedDoc)
                                }
//                            }
//                            else
//                            {
...
//                            }
    ...
    */
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let history = uhistories[indexPath.row]
        ...
        {
            //populate the cell
            historyCell.uStartTime.text = "Start Time: \(history.startTime)"
            historyCell.uEndTime.text = "End Time: \(history.endTime)"
            historyCell.uDuration.text = "Duration: \(String(history.duration))"
            historyCell.uRound.text = "Repeated: \(String(history.repeat))"
            historyCell.uCompleted.text = "Completed: \(String(history.completed))"
        }
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        if segue.identifier == "ShowHistoryDetailSegue"
        {
              ...
              let selectedHistory = uhistories[indexPath.row]
